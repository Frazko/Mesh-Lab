...
classpath=[android,flutter,annotations,jar('org.jetbrains.kotlin','kotlin-stdlib',version),jar('org.jetbrains.kotlinx','kotlinx-coroutines-core-jvm','1.10.2'),jar('org.jetbrains.kotlinx','kotlinx-coroutines-android','1.10.2'),jar('junit','junit',os.environ.get('MESH_JUNIT_VERSION','4.13.2')),jar('org.hamcrest','hamcrest-core','1.3')]
...
subprocess.run([str(java),*coverage,f'-Djava.library.path={ROOT / "target/debug"}','-cp',cp([out,*classpath]),'org.junit.runner.JUnitCore','com.frazko.mesh_host.NativeContractTest','com.frazko.mesh_host.EnrollmentRecordCodecTest','com.frazko.mesh_host.BleWriteQueueTest','com.frazko.mesh_host.BleLinkHealthTest'],check=True,cwd=ROOT)
