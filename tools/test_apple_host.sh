...
swiftc platforms/mesh_host/ios/mesh_host/Sources/mesh_host/MeshEnvelope.swift platforms/mesh_host/ios/mesh_host/Sources/mesh_host/BleFrameCodec.swift platforms/apple/tests/main.swift \
